...
![Detection matrix for automated ship detector used in Two Rocks East site. The
...
reviewing the detections and the LTSA.](/images/Table.2.PNG)
...
library(tidyverse)
library(gt)
Table_3 <- read_csv("data/Example_Tbl3_AMPreport.csv")
#| tbl-cap-location: margin
knitr::kable(
  Table_3[1:4, 1:4], caption = 'Vessel variance.'
)
...
the park boundaries surrounding Two Rocks East and Two Rocks West sites.](/images/Table.4.PNG)
